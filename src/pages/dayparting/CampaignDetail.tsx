...
export default function CampaignDetail() {
  ...
  const summary = calculateHourlySummary(campaign.hourlyData);
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-xs font-medium text-muted-foreground uppercase">Budget</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-xl font-semibold">{formatCurrency(campaign.budget)}</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
            ...
            <CardContent>
              <p className="text-xl font-semibold">{formatCurrency(campaign.spend)}</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
            ...
            <CardContent>
              <p className="text-xl font-semibold">{formatCurrency(campaign.revenue)}</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
            ...
            <CardContent>
              <p className={cn("text-xl font-semibold", campaign.roas >= 3 ? "text-success" : "text-foreground")}>
              ...
              <div className="space-y-3">
                {campaignSchedules.map((schedule) => (
                  <div
                    ...
                    onClick={() => navigate(`/dayparting/scheduled/${schedule.id}/edit`)}
                  >
                    <div>
                      <p className="font-medium">{schedule.name}</p>
                      <p className="text-sm text-muted-foreground">
                        {schedule.actionType.replace("_", " ")} • {schedule.hours.length} hours • {schedule.repeatType}
                      </p>
                    </div>
                    <Badge
                      variant="outline"
