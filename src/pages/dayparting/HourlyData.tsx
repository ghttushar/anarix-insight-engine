      ...
      <div className="flex flex-1 min-h-0">
        <div className="flex-1 space-y-6 overflow-auto">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button size="sm" onClick={() => setDataPanel("createSchedule")}>
              <Plus className="mr-2 h-4 w-4" />Create Day Parting Rule
            </Button>
          </div>
          ...
          {activeView === "campaigns" && (
            <div>
              ...
              />
              <div className="mt-3 rounded-lg border border-border overflow-auto">
                <Table>
                  <TableHeader>
