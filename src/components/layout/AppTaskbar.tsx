...
import { Sun, Moon, ChevronDown, User, Settings, LogOut, Search, Check } from "lucide-react";
...
export function AppTaskbar() {
  ...
  return (
    <div className="flex h-12 items-center justify-between border-b border-border bg-card px-4 shrink-0">
      {/* Left: Page context area (empty or breadcrumb) */}
      <div className="flex items-center gap-3" />

      {/* Right: Merged Marketplace/Store + Theme Toggle + Profile */}
        ...
        <DropdownMenu open={mergedDropdownOpen} onOpenChange={setMergedDropdownOpen}>
          ...
          <DropdownMenuContent align="end" className="w-[260px] p-0">
            ...
            <DropdownMenuItem
              ...
              className="flex items-center gap-2 cursor-pointer mx-1"
            >
