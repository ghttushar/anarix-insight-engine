...
import {
  ...
  ChevronDown, ChevronRight, Sparkles, DollarSign, ShoppingBag,
  Link, PanelLeftClose, PanelLeftOpen, Blocks,
} from "lucide-react";
      ...
      <SidebarContent className="py-4 flex flex-col h-full">
        ...
        <div className="px-3 mb-4">
          {!collapsed ? (
            <button
              ...
              className={cn(
                "group relative w-full rounded-lg text-sm font-medium transition-all overflow-hidden",
                "border border-primary/30 bg-card hover:border-primary/60",
                "py-2.5 flex items-center justify-start px-4 gap-3"
              )}
            >
              ...
              <span className="font-aan text-aan aan-gradient-text" style={{ fontSize: "1.5rem", lineHeight: 1 }}>
                Aan
              </span>
            </button>
          ) : (
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  className={cn(
                    "group relative flex w-full items-center justify-center rounded-lg p-2.5 transition-all",
                    "border border-primary/30 bg-card hover:border-primary/60"
                  )}
                >
        ...
        <div className="mt-auto px-3 pt-4 border-t border-border">
          <button
            ...
            className={cn(
              "flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm text-muted-foreground hover:bg-sidebar-accent hover:text-foreground transition-colors",
