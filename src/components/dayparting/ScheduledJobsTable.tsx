          ...
          {schedules.map((schedule) => (
            <TableRow key={schedule.id} className="hover:bg-muted/30">
                  ...
                  {schedule.campaignNames.length === 1 ? (
                    ...
                    <span className="text-sm">
                      ...
                      <span className="text-muted-foreground ml-1">
                        +{schedule.campaignNames.length - 1} more
                      </span>
                    </span>
                  )}
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  {schedule.budgetModifier && (
                    <span className="text-xs text-muted-foreground">
                      {schedule.budgetModifier > 0 ? "+" : ""}{schedule.budgetModifier}%
                    </span>
                  )}
                </div>
              </TableCell>
              ...
              <TableCell className="text-center">
                <Badge
                  variant="outline"
                  className={cn("capitalize", STATUS_STYLES[schedule.status])}
                >
                  {schedule.status}
                </Badge>
              </TableCell>
                ...
                <div className="flex items-center justify-center gap-1">
                  ...
                  {schedule.status !== "draft" && (
                    <Button
                      ...
                      size="icon"
                      className="h-8 w-8"
                      onClick={() => onPauseResume?.(schedule.id)}
                    >
